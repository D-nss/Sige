...
use App\Http\Controllers\AcoesExtensao\ComissaoAcaoController;
use App\Http\Controllers\AcoesExtensao\ComissaoGraduacaoAcaoController;
...
Route::group(['middleware' => ['keycloak-web','check_is_user']], function () {
    ...
    Route::get('/acoes-extensao/inicio', [AcaoExtensaoController::class, 'inicio'])->name('acao_extensao.inicio');
    ...
    Route::get('/acoes-extensao/pendencias/extensao', [AcaoExtensaoController::class, 'dashboard'])->name('acao_extensao.pendencias');
    ...
    Route::put('evento/{evento}/updateCertificado', [EventoController::class, 'updateCertificado'])->name('evento.updateCertificado');
