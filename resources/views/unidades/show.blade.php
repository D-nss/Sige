...
<!-- BEGIN Page Content -->
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item">Detalhes Unidade</li>
                            <li class="breadcrumb-item active">{{$unidade->sigla}}</li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
                        </ol>
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-plus-circle'></i> {{$unidade->sigla}}
                                <small>
                                    Detalhes da Unidade
                                </small>
                            </h1>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                                ...
                                                <h5 class="mb-0 fw-700 text-center mt-3">
                                                    {{$unidade->sigla}}
                                                    <small class="text-muted mb-0">{{$unidade->nome}}</small>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="p-3 text-center">
                                                <a href="javascript:void(0);" class="btn-link font-weight-bold">link site</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
