...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-12">
            ...
            <h2>Link para inscrição fora do prazo: <a href="#">{{ url('/inscritos/novo/' . $evento->id) }}</a></h2>
            <div class="mt-3">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body">
                                    <table class="table m-0 table-bordered table-sm table-hover table-striped" id="table-example">
                                        <thead>
                                            <tr>
                                                <th>Nome</th>
                                                <th>Email</th>
