              ...
              <div class="panel-content">
                <div class="d-flex flex-row pb-3 pt-2  border-top-0 border-left-0 border-right-0">
                    <div class='icon-stack display-3 flex-shrink-0'>
                                        ...
                                        <i class="base base-7 icon-stack-3x opacity-100 color-primary-500"></i> <i class="base base-7 icon-stack-2x opacity-100 color-primary-300"></i> <i class="fal fa-clipboard-user icon-stack-1x opacity-100 color-white"></i>
                                    </div>
                                    <div class="ml-3">
              ...
              <div class="panel-content">
                <div class="d-flex flex-row pb-3 pt-2  border-top-0 border-left-0 border-right-0">
                    <div class='icon-stack display-3 flex-shrink-0'>
                                        <!--<i class="fal fa-circle icon-stack-3x opacity-100 color-primary-500"></i>
                                        <i class="fal fa-clipboard-user icon-stack-1x opacity-100 color-primary-500"></i>-->
                                        <i class="base base-7 icon-stack-3x opacity-100 color-success-500"></i> <i class="base base-7 icon-stack-2x opacity-100 color-success-300"></i> <i class="fal fa-calendar-check icon-stack-1x opacity-100 color-white"></i>
                                    </div>
                                    <div class="ml-3">
                                    <h5 class="mb-0 flex-1 text-dark fw-500">
