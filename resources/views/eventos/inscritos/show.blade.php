...
@section('content')
    <div class="subheader">
        ...
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-user'></i>Olá, {{ $inscrito->nome }}
            <small>
            ...
            <div class="panel-container show">
                ...
                <div class="panel-content">
                    <ul class="nav nav-pills nav-fill" role="tablist">
                        <li class="nav-item active"><a class="nav-link active" data-toggle="tab" href="#tab_default-1"
                                role="tab" aria-selected="true"><i class="fal fa-home mr-1"></i> Sua Inscrição e
                                Evento</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab_default-2" role="tab"
                                aria-selected="false"><i class="fal fa-user mr-1"></i> Dados do Inscrito</a></li>
                        @if ($inscrito->evento->ck_arquivo)
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab_default-3" role="tab"
                                    aria-selected="false"><i class="fal fa-file-archive mr-1"></i> Submeter Trabalho</a>
                            </li>
                        @endif
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab_eventos" role="tab"
                                aria-selected="false"><i class="fal fa-clock mr-1"></i> Eventos Inscritos</a></li>
                        @if (strtotime(date('Y-m-d')) > strtotime($inscrito->evento->data_fim) && $inscrito->presenca == 1)
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab_certificados"
                                    role="tab" aria-selected="false"><i class="fal fa-file-certificate mr-1"></i>
                                    Certificados</a></li>
                        @endif
                    </ul>
                    <div class="tab-content p-3">
                        <div class="tab-pane fade active show" id="tab_default-1" role="tabpanel">
                            @if ($inscrito->evento->ck_arquivo)
                                @if (is_null($inscrito->status_arquivo))
                                    <div class="panel-tag">
                                        Inscrição ainda não possui trabalho submetido. O envio do arquivo não é obrigatório,
                                        somente se você for <code>apresentar algum projeto</code> no evento.
                                    </div>
                                @endif
                            @endif
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>Você deseja realmente cancelar inscricao ao evento?
                                                                    </p>
                                                                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="p-0">
                                                <h5>
                                                    ...
                                                    <small
                                                        class="mt-0 mb-3 font-size-16 fw-400 text-uppercase text-uppercase">
                                ...
                                <div class="col-md-3">
                                    ...
                                    @if (!is_null($inscrito->desc_deficiencia))
                                        <div class="col-12">
                                            <div class="p-0">
                                                <h5>
                                                    <span class="font-color-light font-size-14">Descrição
                                                        Deficiência</span>
                                                    <small class="mt-0 mb-3 font-size-16 fw-400 text-uppercase">
                                                            ...
                                                            @elseif($inscrito->status_arquivo == 'Recusado')
                                                                ...
                                                                @if ($inscrito->recurso_arquivo == null)
                                                                    <button type="button"
                                                                        ...
                                                                        data-toggle="modal" data-target="#recursoModal">
                                                                        Abrir Recurso
                                                                    </button>

                                                                    <!-- Modal -->
                                                                    <div class="modal fade" id="recursoModal"
                                                                        tabindex="-1" aria-labelledby="recursoModalLabel"
                                                                        aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <form
                                                                ...
                                                                @else
                                                                    ...
                                                                    @if ($userNaComissao && $inscrito->resposta_recurso == null)
                                                                        ...
                                                                        <!-- Modal -->
                                                                        <div class="modal fade" id="aprovaRecursoModal"
                                                                            tabindex="-1"
                                                        ...
                                                        @if (
                                                            ...
                                                            <div class="mt-0 mb-3">
                                                                ...
                                                                <div class="modal fade"
                                                                    id="exampleModal{{ $inscrito->id }}" tabindex="-1"
                                                            ...
                                                            <form
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="form-label">Título do
                                                                        Trabalho<span class="text-danger">*</span></label>
                        ...
                        <div class="tab-pane fade" id="tab_eventos" role="tabpanel">
                            <div class="row">
                                @forelse($participados as $dados_inscricao)
                                    <!-- <li class="list-group-item bg-info-50 mb-1"> -->
                                    <div class="col-md-2 bg-light m-2 p-3 d-flex flex-column shadow">
                                        <div class="mb-3">
                                            <h3><a
                                                    href="{{ url('evento/inscrito/' . \Illuminate\Support\Facades\Crypt::encryptString($dados_inscricao->id)) }}"><strong>{{ $dados_inscricao->evento->titulo }}
                                                    </strong></a></h3>
                                            <p><strong>Data:
                                                </strong>{{ date('d/m/Y', strtotime($dados_inscricao->evento->data_inicio)) }}
                                            </p>
                                            <p><strong>Status: </strong><small
                                                    class="mt-0 mb-3 font-size-16 fw-400 text-uppercase text-uppercase">
                        ...
                        <div class="tab-pane fade" id="tab_certificados" role="tabpanel">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-12">
                                        <div class="p-0">
