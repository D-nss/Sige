            ...
            <div class="col-xl-12">
                <div class="panel mt-3 p-3">
                    ...
                    <div class="alert alert-warning">
                        ...
                        Para concluir sua inscrição, é crucial confirmar seu endereço de e-mail o mais rápido possível, pois
                        isso é necessário para validar sua inscrição dentro do prazo estipulado. A inscrição só será
                        efetivada após a confirmação, e enviamos um link para seu e-mail para isso. Certifique-se de
                        verificar sua pasta de Spam se não encontrar o e-mail..
                    </div>
                </div>
            </div>
        </div>
