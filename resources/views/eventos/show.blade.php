                                        ...
                                        <div class="p-0">
                                            <h5>
                                                ...
                                                <small class="mt-0 mb-3 d-flex flex-column">
                                                    ...
                                                    <span class="font-color-light font-size-14">Exigir Instituição de
                                                        Origem</span>
                                                    <small class="mt-0 mb-3 font-size-16 fw-400 text-uppercase">
                                                    ...
                                                    <span class="font-color-light font-size-14">Exigir Autodeclaração
                                                        Étnico Racial</span>
                                                    <small class="mt-0 mb-3 font-size-16 fw-400 text-uppercase">
                                                        {{ is_null($evento->ck_racial) ? 'Não' : 'Sim' }}
                                                    </small>

                                                    <span class="font-color-light font-size-14">Exigir Declaração de
                                                        Deficiência</span>
                                                    <small class="mt-0 mb-3 font-size-16 fw-400 text-uppercase">
