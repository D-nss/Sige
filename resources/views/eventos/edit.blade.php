                            ...
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        ...
                                        @csrf
                                        <div class="panel-tag">
                                            Complete de forma adequada o formulário com as informações relacionadas ao
                                            evento nos campos correspondentes.
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('titulo') is-invalid @enderror"
                                                ...
                                                @if (isset($evento)) value="{{ $evento->titulo }}" @endif>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group border rounded p-3">
                                            ...
                                            <div class="form-group">
                                                <label class="fw-700"><i class="far fa-check-circle fa-1x mr-2"></i>Local do
                                                    Evento</label>
                                                <input type="text"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Digite o endereço do local do Evento."
                                                    value="@if (isset($evento)) {{ $evento->endereco }} @endif">
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="@if (isset($evento)) {{ $evento->latitude }} @endif">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="@if (isset($evento)) {{ $evento->longitude }} @endif">
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group border rounded p-3">
                                            ...
                                            <label for="local" class="fw-700"><i
                                                    class="far fa-check-circle fa-1x mr-2"></i>Tipo do Evento</label>
                                            <div class="custom-control custom-switch">
                                                <input class="custom-control-input" type="checkbox" id="gratuito"
                                                    name="gratuito" value="1"
                                                    @if (isset($evento) && $evento->gratuito == 1) checked="true" @endif>
                                                <label class="custom-control-label" for="gratuito">
                                                    Gratuito
                                                </label>
                                            </div>
                                            <div class="{{ isset($evento->valor_inscricao) ? 'form-group d-block' : 'form-group d-none' }}"
                                                id="div_valor_inscricao">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ isset($evento->valor_inscricao) ? number_format($evento->valor_inscricao, 2, ',', '') : old('valor_inscricao') }}">
                                                <span class="text-danger" id="msg_erro_valor_inscricao"></span>
                                            </div>
                                            <div class="custom-control custom-switch">
                                                <input class="custom-control-input" type="checkbox" id="online"
                                                    name="online" value="1"
                                                    @if (isset($evento) && $evento->online == 1) checked="true" @endif>
                                                <label class="custom-control-label" for="online">
                                                    On-line
                                                </label>
                                            </div>
                                            <div class="custom-control custom-switch">
                                                <input class="custom-control-input" type="checkbox" id="hibrido"
                                                    name="hibrido" value="1"
                                                    @if (isset($evento) && $evento->hibrido == 1) checked="true" @endif>
                                        ...
                                        <div class="form-group border rounded p-3">
                                            <label for="local" class="fw-700"><i
                                                    class="far fa-calendar-alt mr-2"></i>Período do Evento</label>
                                            <div class="form-input">
                                                <label class="form-label fw-400" for="data_inicio">
                                                    Inicio do Evento
                                                </label>
                                                <input
                                                    class="form-control @error('data_inicio') is-invalid @enderror w-25"
                                                    type="datetime-local" id="data_inicio" name="data_inicio"
                                                    @if (isset($evento)) value="{{ $evento->data_inicio }}" @endif>
                                            ...
                                            <div class="form-input mt-2">
                                                ...
                                                <input class="form-control @error('data_fim') is-invalid @enderror w-25"
                                                    ...
                                                    @if (isset($evento)) value="{{ $evento->data_fim }}" @endif>

                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label fw-700" for="detalhes">Detalhes (Notas do Evento,
                                                Programação, Palestrantes):</label>
...
@endif
                                        ...
                                        <div class="form-group border rounded p-3">
                                            <label for="inscricao" class="fw-700"><i
                                                    class="far fa-edit mr-2"></i>Inscrições</label>
                                            <div class="custom-control custom-switch mb-3">
                                                <input class="custom-control-input" type="checkbox" id="inscricao"
                                                    name="inscricao" value="1"
                                                    @if (isset($evento->inscricao_inicio)) checked @endif>
                                                <label class="custom-control-label" for="inscricao">
                                                    Terá Inscrição?
                                                </label>
                                            </div>
                                            <div class="@if (!isset($evento->inscricao_inicio)) d-none @endif"
                                                id="evento_inscricao">
                                                <div class="form-input">
                                                    ...
                                                    <input
                                                        class="form-control @error('inscricao_inicio') is-invalid @enderror w-25"
                                                        type="datetime-local" id="inscricao_inicio"
                                                        name="inscricao_inicio"
                                                        @if (isset($evento->inscricao_inicio)) value="{{ $evento->inscricao_inicio }}" @endif>
                                                ...
                                                <div class="form-input mt-2">
                                                    ...
                                                    <input
                                                        class="form-control @error('inscricao_fim') is-invalid @enderror w-25"
                                                        type="datetime-local" id="inscricao_fim" name="inscricao_fim"
                                                        @if (isset($evento->inscricao_inicio)) value="{{ $evento->inscricao_fim }}" @endif>
                                                ...
                                                <div class="form-input mt-3">
                                                    ...
                                                    <input class="form-control @error('vagas') is-invalid @enderror w-25"
                                                        type="number" name="vagas" id="vagas"
                                                        placeholder="Ilimitado"
                                                        @if (isset($evento->inscricao_inicio)) value="{{ $evento->vagas }}" @endif>

                                                    <div class="mt-3">
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_documento" name="ck_documento" value="1"
                                                                @if (isset($evento->ck_documento)) checked @endif>
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_sexo" name="ck_sexo" value="1"
                                                                @if (isset($evento->ck_sexo)) checked @endif>
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_identidade_genero" name="ck_identidade_genero"
                                                                value="1"
                                                                @if (isset($evento->ck_identidade_genero)) checked @endif>
                                                            <label class="custom-control-label mb-2"
                                                                for="ck_identidade_genero">
                                                                Exigir Identidade de Gênero
                                                            </label>
                                                        </div>
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_nascimento" name="ck_nascimento" value="1"
                                                                @if (isset($evento->ck_nascimento)) checked @endif>
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_instituicao" name="ck_instituicao" value="1"
                                                                @if (isset($evento->ck_instituicao)) checked @endif>
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_vinculo" name="ck_vinculo" value="1"
                                                                @if (isset($evento->ck_vinculo)) checked @endif>
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_area" name="ck_area" value="1"
                                                                @if (isset($evento->ck_area)) checked @endif>
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_funcao" name="ck_funcao" value="1"
                                                                @if (isset($evento->ck_funcao)) checked @endif>
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_pais" name="ck_pais" value="1"
                                                                @if (isset($evento->ck_pais)) checked @endif>
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_cidade_estado" name="ck_cidade_estado"
                                                                value="1"
                                                                @if (isset($evento->ck_cidade_estado)) checked @endif>
                                                            <label class="custom-control-label mb-2"
                                                                for="ck_cidade_estado">
                                                                Exigir Cidade/Estado
                                                            </label>
                                                        </div>
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_racial" name="ck_racial" value="1"
                                                                @if (isset($evento->ck_racial)) checked @endif>
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_deficiencia" name="ck_deficiencia" value="1"
                                                                @if (isset($evento->ck_deficiencia)) checked @endif>
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                id="ck_arquivo" name="ck_arquivo" value="1"
                                                                @if (isset($evento->ck_arquivo)) checked @endif>
                                                            <label class="custom-control-label mb-2" for="ck_arquivo">
                                                                Exigir Arquivo de Projeto
                                                            </label>
                                                        </div>
                                                        <div class="form-group {{ isset($evento->ck_arquivo) ? 'd-block' : 'd-none' }}"
                                                            ...
                                                            <input
                                                                ...
                                                                type="date" name="prazo_envio_arquivo"
                                                                id="prazo_envio_arquivo"
                                                                @if (isset($evento->prazo_envio_arquivo)) value="{{ $evento->prazo_envio_arquivo }}" @endif>
                                                        </div>
                                                        <div class="form-group mt-2">
                                                            ...
                                                            <input class="form-control" type="text"
                                                                name="input_personalizado" id="input_personalizado"
                                                                placeholder="Digite o texto do campo personalizado ..."
                                                                @if (isset($evento->input_personalizado)) value="{{ $evento->input_personalizado }}" @endif>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-group border rounded p-3">
                                            ...
                                            <div class="custom-control custom-switch mb-3">
                                                <input class="custom-control-input" type="checkbox" id="certificado"
                                                    @if (isset($evento->certificado)) checked @endif>
                                            ...
                                            <div class="@if (!isset($evento->certificado)) d-none @endif"
                                                id="evento_certificado">
                                                <div class="custom-control custom-switch mb-3">
                                                    <input class="custom-control-input" type="checkbox"
                                                        id="enviar_modelo" name="enviar_modelo" value="1"
                                                        @if (isset($evento->certificado)) checked @endif>
                                                ...
                                                <div class=" @error('modelo') border border-danger rounded p-3 @enderror">
                                                    <div class="form-group @if (!isset($evento->certificado) && !$evento->certificado) d-none @endif "
                                                        id="carregar_modelo">
                                                        <label class="control-label font-weight-bold text-success">Upload
                                                            do modelo do certificado</label>
                                                        ...
                                                        <div class="dropzone-wrapper">
                                                            <div class="dropzone-desc">
                                                                ...
                                                                <p class="font-weight-bold">Arraste o arquivo aqui ou
                                                                    clique para selecionar.</p>
                                                                <p class="text-info fs-sm">O arquivo deve ser no formato
                                                                    PNG</p>
                                                            </div>
                                                            <input type="file" name="modelo" class="dropzone"
                                                                id="modelo" value="{{ old('modelo') }}">
                                                ...
                                                <input class="form-control w-25" type="number" name="carga_horaria"
                                                    ...
                                                    @if (isset($evento->carga_horaria)) value="{{ $evento->carga_horaria }}" @endif>
                                                <div class="custom-control custom-switch mb-3">
                                                    <input class="custom-control-input" type="checkbox"
                                                        id="doc_certificado" name="doc_certificado" value="1"
                                                        @if (isset($evento->doc_certificado)) checked @endif>
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="exampleModal{{ $evento->id }}" tabindex="-1"
                                            aria-labelledby="exampleModalLabel{{ $evento->id }}" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <form action="{{ url('eventos/' . $evento->id) }}" method="post">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="exampleModalLabel{{ $evento->id }}">Alerta</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            @csrf
                                                            @method('DELETE')
                                                            <p>Deseja cancelar o evento <span
                                                                    class="fw-500">{{ $evento->titulo }}</span>?</p>
