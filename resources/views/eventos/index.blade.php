                                ...
                                @if (count($eventosPendentes) > 0)
                                    <div class="card-header" id="headingOne">
                                        <a href="javascript:void(0);" class="card-title" data-toggle="collapse"
                                            data-target="#collapseEventosPendentes" aria-expanded="true"
                                    ...
                                    <div id="collapseEventosPendentes" class="collapse show" aria-labelledby="headingOne"
                                        data-parent="#accordionExample">
                                        <div class="card-body">
                                            @include('eventos._table_pendentes')
                                        </div>
                                    </div>
                                @endif
