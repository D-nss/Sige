        ...
        <tr>
            ...
            <td>
                <div class="btn-group-vertical" style="width: 180px" role="group" aria-label="Vertical button group">
                    ...
                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal{{ $evento->id }}">
                        <span class="a-ic-bt-peq fal fa-shield-alt"></span>Comissão
                    </a>
                    <!-- Modal center Small -->
                                ...
                                <ul class="list-group ">
                                    ...
                                    <li class="list-group-item m-3">
                                        <button type="button"
                                            ...
                                            data-toggle="modal" data-target="#exampleModal{{ $evento->comissao->id }}">
                                        ...
                                        <div class="modal fade" id="exampleModal{{ $evento->comissao->id }}"
                                            tabindex="-1" aria-labelledby="exampleModalLabel{{ $evento->comissao->id }}"
                                            aria-hidden="true">
