                    ...
                    <table id="dt-acoes-extensao" class="table table-bordered table-hover table-striped w-100">
                        ...
                        <tbody>
                            ...
                            @foreach($curricularizacoes as $curricularizacao)
                                <tr>
                                    <td>
                                        <div class="fs-xl fw-700 text-primary">{{ $curricularizacao->aluno_ra[0]->MALUCOMPL }}</div>
                                        <div class="fs-md text-success">{{ $curricularizacao->aluno_ra[0]->NIVFORM }} - {{ $curricularizacao->aluno_ra[0]->MUNIDENSI }}</div>
                                        <div class="fs-xs text-muted mb-1">{{ $curricularizacao->aluno_ra[0]->SITALUNO }}</div>
