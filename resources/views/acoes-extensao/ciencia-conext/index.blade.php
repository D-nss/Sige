...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item active">Listagem Ciência</li>
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="flex-1">
            ...
            @if($acoes_extensao->count() > 0)
                As ações listadas abaixo já foram enviadas para ciência, e estão aguardando a resposta do Conext.<br>
                Para marcar a ciência selecione as ações desejadas e clique no botão "Marcar Ciência"
...
<div class="subheader">
    <h1 class="subheader-title">
        ...
        Ações de Extensão Reconhecidas pela Comissão de Graduação
        <small>
            Listagem das Ações de Extensão a serem tomadas ciência pelo conext
        </small>
    </h1>
</div>
