                        ...
                        <table class="table table-bordered table-hover" id="dt-propostas" style="width: 100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('acoes-extensao-ocorrencia/' . $acaoExtensaoOcorrencia->id . '/equipe/' . $membro->id . '/editar') }}" class="btn btn-info btn-xs">Editar</a>
                                        <a href="{{ url('acoes-extensao-ocorrencia/' . $acaoExtensaoOcorrencia->id . '/equipe/' . $membro->id . '/show') }}" class="btn btn-primary btn-xs">Ver</a>
