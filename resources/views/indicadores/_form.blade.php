...
<div class="p-3 sw-container tab-content">
    ...
    <div class="mt-5">
            <div class="mb-3 form-group">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <select class="form-control" name="ano_base" placeholder="Selecione ..." required="required" pattern="[0-9]+$" @if(explode('/', Request::url())[5] == 'editar') tabindex="-1" aria-disabled="true" readonly @endif>
