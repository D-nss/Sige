...
<div class="p-3 sw-container tab-content">
    ...
    <div class="mt-5">
            <div class="mb-3 form-group">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <input type="number" class="form-control" name="ano_base" value="{{ isset($ano) ? $ano : isset($indicadoresParametros)}}" placeholder="Ex: 2022" {{ isset($ano) ? 'readonly' : ''}} required="required" pattern="[0-9]+$">
                        @error( 'ano_base' )
