...
<div class="subheader">
    <h1 class="subheader-title">
        <span class="text-success"><i class='subheader-icon fal fa-plus'></i>Indicadores</span>
        <small>
        Adicionar itens de indicadores da unidade
        </small>
    </h1>
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <form action="{{ url('/indicadores-itens') }}" method="post">
                                    @csrf
                                    <div class="p-4">

                                    @include('indicadores.itens._form')

                                    </div>
                                    <button class="btn btn-primary mx-4 mb-4">Adicionar</button>
                                </form>
                            </div>
                        </div>
                    </div>
