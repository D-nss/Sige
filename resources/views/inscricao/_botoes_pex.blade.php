<div class="">
    ...
    <button type="button" class="btn btn-success btn-xs my-1" data-toggle="modal" data-target="#modalContemplar{{ $inscricao->id}}"><i class="far fa-dollar-sign"></i> Contemplar</button>
    <!-- Modal center Small -->
    <div class="modal fade" id="modalContemplar{{ $inscricao->id}}" tabindex="-1" role="dialog" aria-hidden="true">
