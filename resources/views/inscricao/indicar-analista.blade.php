...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item active">Analista de Inscrição</li>
    <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
</ol>

<div class="subheader">
    <h1 class="subheader-title">
        <span class="text-success">Indicar Analista</span>
        <small>
            ...
            <div class="col-lg-12">
              <div class="card">
                  <div class="card-body">
                      ...
                      @endif
                      <a href="javascript:history.back()" class="btn btn-secondary btn-user float-left mt-2">
