                                    ...
                                    <h3 class="text-success">Detalhamento</h3>
                                        ...
                                        @foreach($edital->questoes as $questao)
                                            ...
                                            @if($questao->tipo == 'Complementar')
                                                ...
                                                <textarea class="form-control" name="questao-{{ $questao->id }}" id="questao-{{ $questao->id }}" maxlenght="10000" cols="30" rows="5" required oninput="contadorCaracteresFaltantes('questao-{{ $questao->id }}')">@if(isset($respostasQuestoes)) {{ $respostasQuestoes[$i]->resposta }}  @else {{ old("questao-$questao->id") }} @endif</textarea>
