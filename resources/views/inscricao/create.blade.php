...
@section('title', 'Cadastrar nova Inscrição')
                        ...
                        <div id="swproposta">
                            ...
                            <div class="tab-content mt-3">
                                    ...
                                    <div id="step-1" class="tab-pane" role="tabpanel">
                                        ...
                                        <ul class="list-group-flush">
                                            @foreach($edital->criterios as $criterio)
                                                <li class="list-group-item text-muted fs-xs">{{ $criterio->descricao }}</li>
                                            @endforeach
                                        </ul>

                                        <h3 class="text-primary fw-700">Dados</h3>
                                        ...
                                        <h4 class="text-primary fw-700">Local do projeto</h4>
                                        ...
                                        <h4 class="text-primary fw-700">Há parcerias com outras instituições (públicas ou privadas) para o desenvolvimento do projeto?</h4>
                                        ...
                                        <h4 class="text-primary fw-700">Informações do projeto: </h4>
                                    ...
                                    <div id="step-2" class="tab-pane" role="tabpanel">
                                        <h3 class="text-primary fw-700">Detalhamento</h3>
                                            <?php $i = 0; ?>
                                    ...
                                    <div id="step-3" class="tab-pane" role="tabpanel">
                                        <h3 class="text-primary fw-700">Áreas Temáticas</h3>
                                    ...
                                    <div id="step-4" class="tab-pane" role="tabpanel">
                                        <h3 class="text-primary fw-700">Linhas de Extensão</h3>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-primary btn-pills waves-effect" data-dismiss="modal">Fechar</button>
                    </div>
                </div>
            </div>
        </div>
