                                ...
                                <div id="step-3" class="tab-pane" role="tabpanel">
                                    ...
                                    <select name="areas_tematicas[]" id="areas_tematicas" class="form-control mb-3" style="height: 150px;" multiple required>
                                        ...
                                        @foreach($areas_tematicas as $key => $area_tematica)
                                            <option value="{{ $area_tematica->id }}" {{ (collect( old('areas_tematicas') )->contains($area_tematica)) ? 'selected' : '' }}  @if(  (isset($inscricao->areas) && $inscricao->areas->contains($area_tematica->id))) selected @endif>{{ $area_tematica->nome . ' - ' . $key}}</option>
                                        @endforeach
