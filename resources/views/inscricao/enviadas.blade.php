                            ...
                            <td>
                                ...
                                <a href='{{ url("inscricao/$inscricao->id/orcamento") }}' class="btn btn-primary m-1">
                                    ...
                                    @if( empty($inscricao->orcamento->toArray()) )
                                        <span class="badge bg-danger-300 ml-2 px-2" data-toggle="tooltip" data-placement="top" title="Você possui uma pendência! Preenchimento do orçamento"><strong>!</strong></span>
                                    @endif
                                </a>
