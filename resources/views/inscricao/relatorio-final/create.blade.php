                            ...
                            <div class="p-0">
                                ...
                                Período de Realização
                                    <form action="{{ route('edital.relatorio-final.execucao',['inscricao' => $inscricao])}}" method="post">
                                        ...
                                        <input type="date" class="form-control mb-2" name="execucao_inicio" id="execucao_inicio" @if(!is_null($inscricao->execucao_inicio)) value="{{ date('Y-m-d', strtotime($inscricao->execucao_inicio)) }}" @endif>
                                        <label for="execucao_fim" class="fs-sm">Fim Execução</label>
                                        <input type="date" class="form-control mb-2" name="execucao_fim" id="execucao_fim" @if(!is_null($inscricao->execucao_fim)) value="{{ date('Y-m-d', strtotime($inscricao->execucao_fim)) }}" @endif>
