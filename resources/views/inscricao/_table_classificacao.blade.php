    ...
    <tbody>
        @foreach($inscricoes as $inscricao)
            <tr>
                ...
                <td><small class="font-italic font-color-light">{{ $inscricao->linha_extensao->nome}}</small></td>
                ...
                <td><h6 class="font-italic font-color-light">{{ $inscricao->subcomissao[0]->nome }}</h6></td>
