<header id="Extecult-header" class="page-header" role="banner">
    ...
    <div class="hidden-md-down dropdown-icon-menu position-relative">
        ...
        <ul>
            <li>
                <a href="#" class="btn js-waves-off" data-action="toggle" data-class="nav-function-minify" title="Simplificar Menu">
                    <i class="ni ni-minify-nav"></i>
                </a>
            </li>
            <li>
                <a href="#" class="btn js-waves-off" data-action="toggle" data-class="nav-function-fixed" title="Travar Menu">
    ...
    <div class="ml-auto d-flex">
        ...
        <div class="hidden-sm-up">
            <a href="#" class="header-icon" data-action="toggle" data-class="mobile-search-on" data-focus="search-field" title="Pesquisa">
            ...
            <div class="dropdown-menu dropdown-menu-animated w-auto h-auto">
                <div class="dropdown-header bg-trans-gradient d-flex justify-content-center align-items-center rounded-top">
                    <h4 class="m-0 text-center color-white">
                        Meus Serviços
                        <small class="mb-0 opacity-80">Funcionalidades SIGE</small>
                    </h4>
                </div>
                ...
                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                        ...
                        <div class="info-card-text">
                            ...
                            <span class="text-truncate text-truncate-md opacity-80">{{Str::upper(Auth::user()->unidade)}} @endif</span>
                        </div>
                    </div>
                </div>
