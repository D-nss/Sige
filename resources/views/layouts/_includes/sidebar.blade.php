        ...
        <div class="info-card">
            ...
            <div class="info-card-text">
                @if(Auth::hasUser())
                    ...
                    <span class="d-inline-block text-truncate text-truncate-sm">{{ Str::of(Str::before(Auth::user()->name, ' '))->trim() }}, @if(isset($user)) {{Str::upper($user->unidade->sigla)}} @endif </span><br>
